...
func (f *fakeOrderService) UpdateStatus(ctx context.Context, id uuid.UUID, status model.OrderStatus) (dto.OrderResponse, error) {
...
func TestOrderController_FindOrderByID_HappyPath(t *testing.T) {
	router, _ := newOrderRouter(&fakeOrderService{findByIDResp: dto.OrderResponse{ID: uuid.New(), Status: model.OrderStatusPending}})
...
func TestOrderController_Pay_HappyPath(t *testing.T) {
	router, _ := newOrderRouter(&fakeOrderService{payResp: dto.OrderResponse{ID: uuid.New(), Status: model.OrderStatusPaid}})
...
func TestOrderController_UpdateOrderStatus_HappyPath(t *testing.T) {
	router, _ := newOrderRouter(&fakeOrderService{updateStatusResp: dto.OrderResponse{ID: uuid.New(), Status: model.OrderStatusCanceled}})
