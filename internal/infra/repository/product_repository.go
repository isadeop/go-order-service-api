...
func (repo *ProductRepository) Create(ctx context.Context, product domain.Product) (domain.Product, error) {
	...
	if err != nil {
		return domain.Product{}, mapDatabaseErrorProduct("create product", err)
	}
...
func (repo *ProductRepository) FindByID(ctx context.Context, id uuid.UUID) (domain.Product, error) {
...
func (repo *ProductRepository) FindByIDForUpdate(ctx context.Context, tx txport.Tx, id uuid.UUID) (domain.Product, error) {
	...
	if err != nil {
		return domain.Product{}, fmt.Errorf("find product by id for update: %w", err)
	}

	return product, nil
}

func (repo *ProductRepository) FindByName(ctx context.Context, name string) (domain.Product, error) {
	...
	if err != nil {
		return domain.Product{}, fmt.Errorf("find product by name: %w", err)
	}

	return product, nil
}

func (repo *ProductRepository) Update(ctx context.Context, tx txport.Tx, id uuid.UUID, product domain.Product) (domain.Product, error) {
	...
	if err != nil {
		return domain.Product{}, mapDatabaseErrorProduct("update product", err)
	}
