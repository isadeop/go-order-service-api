...
func TestClientRepository_Create_EmailDuplicado(t *testing.T) {
	...
	_, err := repo.Create(context.Background(), model.Client{
		Name:         "Outro Nome",
...
func TestClientRepository_Update_HappyPath(t *testing.T) {
	...
	updated, err := repo.Update(context.Background(), created.ID, model.Client{
...
func TestClientRepository_Update_NaoEncontrado(t *testing.T) {
	...
	_, err := repo.Update(context.Background(), uuid.New(), model.Client{
		Name:  "Nome",
