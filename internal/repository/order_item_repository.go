...
func (repo *OrderItemRepository) FindByID(ctx context.Context, id uuid.UUID) (model.OrderItem, error) {
	...
	if errors.Is(err, pgx.ErrNoRows) {
		return model.OrderItem{}, custom_errors.ErrOrderItemNotFound
	}

	if err != nil {
		return model.OrderItem{}, fmt.Errorf("find order of item by id: %w", err)
	}
